import { faCircleUser, faComments, faBookmark, faCalendarDays, faChevronUp, faChevronDown, faThumbsUp, faFire, faCheckCircle, faClock, faTrash, faUsers, faChartLine, faLandmark } from "@fortawesome/free-solid-svg-icons";
...
export const UserMenu: FC<UserMenuProps> = ({ className = '' }) => {
    ...
    const handleLogout = () => { logout(); navigate("/inicio-sesion"); }
    const handleDeleteAccount = () => { logout(); navigate("/inicio-sesion"); }
    return (
        <div className={`dropdown ${className}`}>
            ...
            <ul className="dropdown-menu px-3 py-4 mt-3" style={{ minWidth: '300px' }}>
                <li>
                    <span className="fs-5 fw-bold px-3">¡Hola {user?.username || "User"}!</span>
                </li>
                ...
                <li>
                    <button
                        ...
                        onClick={(e) => { e.stopPropagation(); setIsOpenEventos(!isOpenEventos); }}
                    >
                        <FontAwesomeIcon icon={faCalendarDays} className="col-1 me-2" />
                        <span className="col">Eventos</span>
                        <FontAwesomeIcon icon={isOpenEventos ? faChevronUp : faChevronDown} />
                    </button>
                </li>
                <div className="collapse px-3" id="eventosCollapse" onClick={(e) => e.stopPropagation()}>
                    <ul className="list-unstyled">
                        ...
                        <li><hr className="dropdown-divider mx-3" /></li>
                        <li>
                            <Link to="/eventos/recomendados" className="dropdown-item py-2 btn">
                        ...
                        <li><hr className="dropdown-divider mx-3" /></li>
                        <li>
                            <Link to="/eventos/asistidos" className="dropdown-item py-2 btn">
                        ...
                        <li><hr className="dropdown-divider mx-3" /></li>
                        <li>
                            <Link to="/eventos/proximos" className="dropdown-item py-2 btn">
                ...
                <li>
                    <button
                        ...
                        onClick={(e) => { e.stopPropagation(); setIsOpenLugares(!isOpenLugares); }}
                    >
                        <FontAwesomeIcon icon={faLandmark} className="col-1 me-2" />
                        <span className="col">Lugares culturales</span>
                        <FontAwesomeIcon icon={isOpenLugares ? faChevronUp : faChevronDown} />
                    </button>
                </li>
                <div className="collapse px-3" id="lugaresCollapse" onClick={(e) => e.stopPropagation()}>
                    <ul className="list-unstyled">
                        <li><hr className="dropdown-divider mx-3" /></li>
                        {user?.role === ADMIN_ROLE && (
                            <>
                                <li>
                                    <Link to="/lugares-culturales" className="dropdown-item py-2 btn">
                                        <FontAwesomeIcon icon={faLandmark} className="col-1 me-2" />
                        ...
                        <li>
                            <Link to="/lugares-culturales/recomendados" className="dropdown-item py-2 btn">
                                <FontAwesomeIcon icon={faThumbsUp} className="col-1 me-2" />
                                <span className="col">Recomendaciones</span>
                            </Link>
                        </li>
                        <li><hr className="dropdown-divider mx-3" /></li>
                        <li>
                            <Link to="/lugares-culturales/populares" className="dropdown-item py-2 btn">
                                <FontAwesomeIcon icon={faFire} className="col-1 me-2" />
                                <span className="col">Populares</span>
                            </Link>
                        </li>
                ...
                <li className="text-center mt-4 mb-3">
                    <button className="btn btn-outline-dark rounded-5 px-4" type="button" onClick={handleLogout}>
                        Cerrar sesión
                    </button>
                </li>
                <li className="text-center">
                    <button className="dropdown-item text-danger btn" type="button" onClick={handleDeleteAccount}>
